...
def test(net, dataloader, DEVICE, flag='test_set'):
    ...
    with torch.no_grad():
        ...
        sklearn_precision, sklearn_recall, sklearn_f1, sklearn_support = metrics.precision_recall_fscore_support(np.array(labels), np.array(prediction_list))
