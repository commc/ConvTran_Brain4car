...
class Transformer_20frame(Module):
    def __init__(self,
                 d_model: int,
                 d_input: int,
                 d_channel: int,
                 ...
                 pe: bool = False,
                 mask: bool = False):
        super(Transformer_20frame, self).__init__()
        ...
        self.output_linear = torch.nn.Linear(d_model * d_input + d_model * d_channel, d_input * d_output)
    ...
    def forward(self, x, stage):
        ...
        output = output.view(-1, self._d_input, self._d_output)
